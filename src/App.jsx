  ...
  return (
    <>
      <main className="flex flex-col h-screen mx-4 my-6 md:my-16 md:mx-28 2xl:my-20 2xl:mx-40">
        ...
        <div className="col-span-full sm:col-span-3 md:col-span-full lg:col-span-4 lg:row-span-2 md:row-start-1">
          <HeroGrid />
        </div>

        <div className="col-span-full sm:col-span-2 md:col-span-full lg:col-start-5 lg:col-end-7 lg:row-span-2 mx-auto w-full bg-very-dark-blue">
          <New />
        </div>
